...
- `FlutterKaigi2026` : FlutterKaigiと2026の間にスペースがない
...
```
本イベントはFlutterKaigi 2026に協賛しているA社（、B社、C社）による主催（共催）です。
```
上記例のように、**協賛の事実および主催を明記**してください。ただし、協賛イベントとしてイベントを開催できる期間は、年度内までとします。（FlutterKaigi 2026協賛の場合は、2027/3/31まで協賛イベントの開催が可能となります。）
